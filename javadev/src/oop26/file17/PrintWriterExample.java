...
public class PrintWriterExample {
	public static void main(String[] args) {
		File printWriter1 = new File("src/oop26/file17/printwriter1.txt");
		File printWriter2 = new File("src/oop26/file17/printwriter2.txt");
		File printWriter3 = new File("src/oop26/file17/printwriter3.txt");
