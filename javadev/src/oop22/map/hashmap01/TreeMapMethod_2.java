...
public class TreeMapMethod_2 {
	public static void main(String[] args) {
		//1. Integer 크기 비교
		System.out.println("---------Integer 크기 비교------------");
		...
		//3. Myclass 객체 크기 비교 부분은 비교할 방법이 없어서 안됨
		
		//4. MyComparableClass 객체 크기 비교 방법 1'
		System.out.println();
		System.out.println("-------------------comparable 크기 비교------------");
		...
		System.out.println();
		System.out.println("------------comparator크기 비교-----------------");
